        ...
        <div className="flex flex-col lg:flex-row items-center justify-center lg:space-x-12">
          <div className="lg:w-1/2">
            <h2 className="text-2xl lg:text-4xl font-bold mb-4 text-gray-100 lg:mb-6 w-5/6">
              Leading the Way in Digital Marketing Solutions
            </h2>
            <p className="text-base lg:text-lg text-gray-100 leading-relaxed mb-4 lg:mb-6 reveal-text">
              At Digital Falak, we pride ourselves on our industry credibility.
              With a track record of success and a team of experts, we deliver
              comprehensive marketing, development, and design solutions that
              drive results.
            </p>
